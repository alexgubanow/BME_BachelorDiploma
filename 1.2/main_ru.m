...
if exist('calc.fig','file')
    openfig('calc.fig', 'reuse')
end

function uipushtool10_ClickedCallback(hObject, eventdata, handles)
close(main_ru)
if exist('launc.fig','file')
    openfig('launc.fig', 'reuse')
end
...
if exist('resize.fig','file')
    openfig('resize.fig', 'reuse')
end
uiwait(resize);
